                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="posts-col middle">
                            ...
                            <p class="p-small">
                        <a class=blue page-scroll href="https://www.doatap.gr/%ce%b5/">Κανόνες για επίσκεψη στον ΔΟΑΤΑΠ</a>
                        </br>
                                </br>
                                </br>
                                </br>
                                ...
                                <a class=blue page-scroll href="https://pagenotfound/">Ανακοίνωση για διδάκτορες, των οποίων  οι τίτλοι τους δεν συμπεριλαμβάνονται στον ΕΑΔΔ</a>
                    ...
                    <div class="col-md-4">
                        <div class="posts-col middle">
                            ...
                            <p class="p-small"><a class=blue page-scroll href="https://pagenotfound/">Γενικές</a>
                                </br>
                                </br>
                                </br>
                                </br>
