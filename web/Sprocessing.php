...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <div class="navbar2 active">
        ...
        <div class="subnav2 active">
            ...
            <div class ACTIVE2-content><a href="Sprocessing.php">Υπο Επεξεργασία</a><active>
    ...
    <header id="header" class="ex-2-header">
                    ...
                    <h6> Προσωρινά Αποθηκευμένες Αιτήσεις</h6>
                    
                    <?php 
                        $fullname= $_SESSION['fullname'];
                        $myapps = mysqli_query($conn, "SELECT * FROM app WHERE fullname='$fullname' AND temporary_app='temporary'");
