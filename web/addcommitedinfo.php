<?php
    ...
    if(isset($_SESSION['id'])){
        ...
        $query =  "SELECT * FROM app WHERE id_of_application=$gotid ";
        $myapp = mysqli_query($conn, $query);
         
         
        $arr = mysqli_fetch_array($myapp);
        
        $_SESSION['stateofapp']= $arr[16];
        $_SESSION['cause']= $arr[18];
       

    }

    if(isset($_POST['acceptapp'])) {
        $qu = "UPDATE app SET accept_refuse = 'confirmed' WHERE id_of_application = $gotid";
        $resultaccept = mysqli_query($conn, $qu);
         
        
        header("Location: ./Scommited.php");
    }
    
    if (isset($_POST['declineapp'])) 
    {
        $query = "UPDATE app SET accept_refuse = 'refused' WHERE id_of_application = $gotid";
...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <header id="header" class="ex-2-header">
                    ...
                    <div style="color:rgb(94, 255, 0);">
                        <?php if( $_SESSION['stateofapp']== 'confirmed'){
                            echo "ΕΠΙΒΕΒΑΙΩΜΕΝΗ" ;
                        }
                        ?>
                    ...
                    <div style="color:rgb(255, 0, 0);">
                        <?php if( $_SESSION['stateofapp']== 'decline'){
                            echo "ΑΠΟΡΡΙΦΘΕΙΣΑ" ;
                            echo  $_SESSION['cause'];
                        }
                        ?>
                    ...
                    <div style="rgb(255, 0, 0);">
                        <?php if( $_SESSION['stateofapp']== 'none'){
                            echo "ΑΝΑΜΕΝΕΤΑΙ ΑΠΑΝΤΗΣΗ" ;
                            echo  $_SESSION['cause'];
                        }
                        ?>
                    ...
                    <div class="form-container">
                        ...
                        <div class="form-group">
                            ...
                            <label class="label-control" for="name-lastname"> <?php echo $arr[1] ?> </label>
                        ...
                        <div class="form-group">
                            ...
                            <label class="label-control" for="name-lastname"> <?php echo $arr[11]; ?> </label>

                            <input type="file" class="form-control-input pleft" name="photo"  accept=".pdf" readonly>
                        ...
                        <div class="form-group">
                            ...
                            <label class="label-control" for="name-lastname"> <?php echo $arr[13]; ?> </label>
                            
                            <input type="file" class="form-control-input pleft"   readonly>
                        ...
                        <div class="form-group">
                            ...
                            <label class="label-control" for="name-lastname"> <?php echo $arr[14]; ?> </label>

                            <input type="file" class="form-control-input pleft"  name="university_certificate" >
                        ...
                        <div class="form-group">
                            ...
                            <label class="label-control" for="name-lastname"> <?php echo $arr[15]; ?> </label>
                        ...
                        <form action = "" method="post">
                            <?php if ($_SESSION['stateofapp']== 'accept') { ?> 
                                <div class="btns-box">
                                    <button class="btn btn2 width-50  btn-prev" type="submit" name="declineapp">Απόρριψη</button>
                                    
                                    <button class="btn btn3 width-50 btn-prev" style="left:150px;" name="acceptapp">Αποδοχή</button>
